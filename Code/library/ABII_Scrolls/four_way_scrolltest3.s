...
MAP_SCREEN_OFFSET_UP		EQU	(-1*BIGGEST_MAP_X)-2
...
SCROLL_GOING_RIGHT		EQU	(-32*BPR)-2

MAP_SCREEN_OFFSET_LEFT		EQU	(-BIGGEST_MAP_X*2)+21
MAP_SCREEN_OFFSET_RIGHT		EQU	(-BIGGEST_MAP_X*2)-1
...
*-Do for y blocks
	...
	move.w	total_fix_x,alien_x_pos
	move.w	fixed_y,total_fix_y
	move.w	fixed_y,alien_y_pos
	
	move.l	y_scroll_pos,d2
	move.l	d2,total_fix_scroll_y
	move.l	y_map_pos,d3
	move.l	d3,total_fix_map_y
	move.l	y_alien_map_pos,d4
	move.l	d4,total_fix_alien_map_y

	add.l	total_fix_scroll_x,d2
	move.l	d2,current_y_screen_position
	add.l	total_fix_map_x,d3
	move.l	d3,current_y_map_mem_position
	add.l	total_fix_alien_map_x,d4
	move.l	d4,current_y_alien_map_mem_position	
	
		
	bra	drawing_please_wait
check_min_add
...
*- Do for x blocks
	...
	move.w	total_fix_y,alien_y_pos
	move.w	fixed_x,total_fix_x
	move.w	fixed_x,alien_x_pos
	
	move.l	x_scroll_pos,d2
	move.l	d2,total_fix_scroll_x
	move.l	x_map_pos,d3
	move.l	d3,total_fix_map_x
	move.l	x_alien_map_pos,d4
	move.l	d4,total_fix_alien_map_x

	add.l	total_fix_scroll_y,d2
	move.l	d2,current_x_screen_position
	add.l	total_fix_map_y,d3
	move.l	d3,current_x_map_mem_position
	add.l	total_fix_alien_map_y,d4
	move.l	d4,current_x_alien_map_mem_position	



	bra	drawing_x_please_wait
check_x_min_add
...
total_fix_scroll_y		dc.l	0
total_fix_alien_map_y		dc.l	0
total_fix_map_y			dc.l	0
total_fix_scroll_x		dc.l	0
total_fix_map_x			dc.l	0
total_fix_alien_map_x		dc.l	0

total_fix_y			dc.w	0
total_fix_x			dc.w	0

y_scroll_pos			dc.l	0	;mem
x_scroll_pos			dc.l	0	;bytes
y_map_pos			dc.l	0
x_map_pos			dc.l	0
x_alien_map_pos			dc.l	0
y_alien_map_pos			dc.l	0
...
*---	get current map positions
	...
	move.l	d3,x_alien_map_pos
	add.l	d2,a0		;add y
	move.l	a0,y_alien_map_pos
...
*---calc where to draw
	...
	move.l	d0,x_scroll_pos
	move.l	d3,y_scroll_pos
...
*--    SET UP ALIEN ADD POSITIONS
	...
	move.l	y_map_pos,d3
	move.l	y_alien_map_pos,d4
	add.l	x_scroll_pos,d2
	move.l	d2,current_alien_draw_position
	add.l	x_map_pos,d3
	move.l	d3,current_map_mem_position
	add.l	x_alien_map_pos,d4
	move.l	d4,current_alien_map_mem_position	
	rts
