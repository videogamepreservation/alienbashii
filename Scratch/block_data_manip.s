...
Load_Block_Data_Into_Memory
	...
	tst.l	d0
	beq.s	could_not_load_block_data
...
Save_Block_Data_To_Disk
	...
	tst.l	d0
	beq.s	could_not_save_block_data
...
Set_New_Attributes
	...
	ext.l	d0
	lsl	d0
	move.b	(a0,d0),d1		;block data, first byte = stand shoot
	move.b	1(a0,d0),d3
...
Set_StandData_for_view
	move.b	CompareData,d2
	andi.b	#$0f,d2
	move.w	Standing_Choice,d1
	lsl.b	#4,d1
	or.w	d1,d2
	move.b	d2,CompareData
...
Blk_Shooting_Strings
	dc.b	"Null       ",0
	dc.b	"Empty Pot  ",0		;0 not available
	dc.b	"Blt Switch1",0
	dc.b	"Blt Switch2",0
	dc.b	"Blt Switch3",0
	dc.b	"Blt Switch4",0
